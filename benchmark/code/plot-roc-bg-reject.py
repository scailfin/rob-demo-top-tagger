...
if __name__ == '__main__':
    ...
    from a set of taggers. Selects the median model based on background reject.
    """
    args = sys.argv[1:]
    if len(args) != 3:
    ...
    plt.plot(
        ...
        start_index=400000,
        output_file=os.path.join(out_dir, 'ROC-BGR.png'),
        get_model=plt.get_median_bg_reject_model
    )
